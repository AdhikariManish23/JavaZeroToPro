    ...
    public static void main(String[] args) {
        ...
        for(int i= 0; i <str.length(); i++){
            ...
            if(ch != ' ' ){
                ...
                sb.reverse();
                ans += sb;    // now move the values of s into ans
                ans += " ";  // giving Space for the sentence
        ...
        // these 2 steps for the Last string(educator) to print because in input there is no Space in the End due to this the last String word will not print and store in String Builder sb
        sb.reverse();
        ans += sb;
